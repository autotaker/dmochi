...
module Language.DMoCHi.Boolean.Flow where
...
import Data.STRef
import Data.Maybe
import Language.DMoCHi.Boolean.Syntax hiding(Proj,Let,App)
import Language.DMoCHi.Boolean.Sort hiding(Tuple)
import qualified Language.DMoCHi.Boolean.Sort   as Sort
import qualified Language.DMoCHi.Boolean.Syntax as Syntax
...
key (Var _ i) = KVar i
key (App _ t1 t2) = KApp (termId t1) (termId t2)
